const footerLinks = {
  ...
  programs: [
    ...
    { label: 'Student Programs', href: '#' },
    { label: 'Community Outreach', href: '#' },
  ],
  connect: [
    { label: 'Contact Us', href: 'mailto:info@kiptere.org' },
      ...
      <div className="container-custom mx-auto px-4 md:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">Kiptere NGO</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-sm">
              Empowering rural Kenyan students through digital education.
              Together, we&apos;re bridging the digital divide one school at a time.
            </p>
            {/* Social Links */}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Kiptere NGO. All rights reserved.
          </p>
